...
public class bmt_delete {
    
    static String         TEST_MODE = "Delete";
    ...
    public static int allocateUnit( bmt_delete_context context ) {
    ...
    public static void main ( String args[] ) {
        ...
        contexts = new bmt_delete_context[numberOfThreads];
        for ( thread = 0; thread < numberOfThreads; thread++ ) {
            contexts[thread] = new bmt_delete_context( thread );
        }
