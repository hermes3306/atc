...
public class bmt_update {
    
    static String         TEST_MODE = "Update";
    ...
    public static int allocateUnit( bmt_update_context context ) {
    ...
    public static void main ( String args[] ) {
        ...
        contexts = new bmt_update_context[numberOfThreads];
        for ( thread = 0; thread < numberOfThreads; thread++ ) {
            contexts[thread] = new bmt_update_context( thread );
        }
