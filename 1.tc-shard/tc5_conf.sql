...
exec dbms_shard.set_shard_range ('sys','TEST', 200000, 'dn1');
exec dbms_shard.set_shard_range ('sys','TEST', 400000, 'dn2');
exec dbms_shard.set_shard_range ('sys','TEST', 600000, 'dn3');
exec dbms_shard.set_shard_range ('sys','TEST', 800000, 'dn4');
exec dbms_shard.set_shard_range ('sys','TEST', 1000000, 'dn5');
