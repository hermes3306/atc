...
server_arr = ['PC1','PC2','PC3','PC4','PC5','PC6','PC7','PC8','PC9', 'PC0']

for srv in range(len(server_arr)):
	print('\n\n### SENSORS OF ' + server_arr[srv] + ' ###')
	dsn = 'DSN=ALTI_UNIXODBC; SERVER='+server_arr[srv]+'; PORT_NO=20300; NLS_USE=UTF8; UID=smssuser; PWD=smssuser'
	...
	print('TOTAL of ['+ server_arr[srv] +'] = {} ' . format(len(data)))
